...
RETRO_EXCLUDE_WORDS = ["software", "japan", "famicom", "japanese", "thousand", "untested", "guide", "circular", "poster", "art", "promotion", "promotional", "soundtrack", "fanart", "import", "lot", "comic", "guidebook", "guides", "remastered"]
...
ITEMS = [
    ...
    #{
    #    "label": "Knights of the Round SNES",
    #    "query": "Knights of the Round",
    #    "max_price": 85,
    #    "min_price": 51,
    #    "require_any": ["Knights of the Round"],
    #    "exclude_words": RETRO_EXCLUDE_WORDS,
    #},
    {
    ...
    },
    {
        ...
        "max_price": 130,
        "min_price": 50,
        "require_words": ["lebron", "james", "201"],
        "require_any": ["psa 8", "psa8", "psa-8"],
        "exclude_words": BASEBALL_CARD_EXCLUDE_WORDS,
        "include_auctions": True,
    },
