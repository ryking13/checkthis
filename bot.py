...
RETRO_EXCLUDE_WORDS = ["software","japan", "japanese", "thousand", "untested", "guide", "circular", "poster", "art", "promotion", "promotional", "soundtrack", "fanart", "import", "lot", "comic", "guidebook", "guides", "remastered"]
